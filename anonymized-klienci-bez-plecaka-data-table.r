...
dt.filtered <- dt.processed %>%
  filter(!grepl('plecak', product_name_5, ignore.case = TRUE)) %>%
  filter(!grepl('plecak', product_name_4, ignore.case = TRUE)) %>%
  filter(!grepl('plecak', product_name_3, ignore.case = TRUE)) %>%
  filter(!grepl('plecak', product_name_2, ignore.case = TRUE)) %>%
  filter(!grepl('plecak', product_name_1, ignore.case = TRUE)) 
View(dt.filtered)
